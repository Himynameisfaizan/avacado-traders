...
$pageTitle = "Our Products | AK Avocado Traders";
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-5 mb-lg-0 reveal">
                <div class="catalog-sidebar">
                    ...
                    <div class="sidebar-widget text-center support-banner">
                        <i class="bi bi-headset banner-icon"></i>
                        <h5>Need Help?</h5>
            ...
            <div class="col-lg-9">
                <div class="filter-bar reveal">
                    ...
                    <div class="sort-box">
                        <label for="sortBy" class="fw-bold text-muted">Sort by:</label>
                ...
                <div class="row g-4">
                    ...
                    if ($total_records > 0) {
                        while ($product = mysqli_fetch_assoc($productsQuery)):
                            $shortDesc = !empty($product['short_desc']) ? $product['short_desc'] : (!empty($product['meta_desc']) && $product['meta_desc'] != $product['pro_name'] ? $product['meta_desc'] : 'Premium quality agricultural export product sourced from reliable farms.');
                    ?>
                            <div class="col-lg-4 col-md-6 col-12 reveal">
                                <div class="product-card h-100 shadow-sm border rounded-4 overflow-hidden d-flex flex-column" style="background: #ffffff; transition: all 0.3s ease;">
                                    <a href="product-details.php?slug=<?php echo $product['slug_url']; ?>" class="product-img-link" style="text-decoration:none;">
                                        <div class="product-img-wrapper" style="height: 230px; overflow: hidden; background: #F8FAF8;">
                                            <img src="admin/assets/img/uploads/<?php echo $product['pro_img']; ?>" alt="<?php echo htmlspecialchars($product['pro_name']); ?>" style="width: 100%; height: 100%; object-fit: contain; padding: 15px; transition: transform 0.5s ease;" onerror="this.src='assets/images/logo/logo.png'">
                                        </div>
                                    </a>
                                    ...
                                    <div class="product-content p-4 d-flex flex-column flex-grow-1">
                                        <a href="product-details.php?slug=<?php echo $product['slug_url']; ?>" style="text-decoration: none;">
                                            <h3 class="product-title" style="font-size: 1.15rem; font-weight: 800; color: #1A4329; margin-bottom: 10px;">
                                                <?php echo htmlspecialchars($product['pro_name']); ?>
                                            </h3>
                                        </a>

                                        <p class="product-short-desc text-muted mb-4" style="font-size: 0.9rem; line-height: 1.6; display: -webkit-box; line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; height: 3.2em;">
                                        ...
                                        <div class="product-actions mt-auto d-flex justify-content-between align-items-center border-top pt-3">
                                            <a href="product-details.php?slug=<?php echo $product['slug_url']; ?>" class="view-details-link small fw-bold" style="color: #1A4329; text-decoration: none; transition: 0.3s;">
                                                View Details <i class="bi bi-arrow-right ms-1"></i>
                                            </a>
                                            <a href="contact.php?product=<?php echo urlencode($product['pro_name']); ?>" class="btn-quote-full small px-3 py-2 rounded" style="text-decoration: none; transition: all 0.3s;">
                                                Request Quote
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <?php
                        ...
                        <div class='col-12 text-center py-5'>
                            <i class='bi bi-box-seam' style='font-size: 50px; color: #ccc; margin-bottom: 15px;'></i>
                            <h3 style='color: #1A4329;'>No Products Found</h3>
                            <p style='color: #666;'>Try selecting a different category or search term.</p>
                            <a href='products.php' class='btn-quote-full mt-3 px-4 py-2 rounded' style='background: #1A4329; color: white; display:inline-block; text-decoration:none;'>Clear All Filters</a>
                        </div>";
                    }
                    ?>
                </div>
                    ...
                    <div class="row reveal mt-5">
                        <div class="col-12">
                            <ul class="k2k-pagination">
                                <?php if ($page > 1): ?>
                                    <li class="prev"><a href="?page=<?php echo ($page - 1) . $queryString; ?>"><i class="bi bi-arrow-left me-2"></i> Prev</a></li>
                                <?php endif; ?>
                                ...
                                <?php if ($page < $total_pages): ?>
                                    <li class="next"><a href="?page=<?php echo ($page + 1) . $queryString; ?>">Next <i class="bi bi-arrow-right ms-2"></i></a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
